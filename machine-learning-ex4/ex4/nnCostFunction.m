...
for t=1:m
    ...
    a3_t = a3(t,:);
    y_t = y(t,:);
    % third layer (output layer's error)
    % 1,10
    d3 = a3_t - y_t;
    % second layer (second layer's error)
    % (26,1)
    d2 = Theta2'*d3'  .* sigmoidGradient([1; Theta1*a1_t'] );
    % del1 is del of first Theta (25,401)
    del1 = del1 + d2(2:end)*a1_t;  
    % del2 is del of second Theta (10,26)
    del2 = del2 + d3' * a2_t;
end
